...
This script works for building the top-of-the book prior to 2012, but in 2012 the CME Group changed the format of the BBO data so hat it does not record the bid and ask that is unchanged. 
